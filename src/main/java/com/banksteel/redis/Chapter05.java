...
public class Chapter05 {
    ...
    public List<Pair<Integer, Integer>> getCounter(Jedis conn, String name, int precision) {
        ...
        for (Map.Entry<String, String> entry : data.entrySet()) {
            results
                .add(new Pair<Integer, Integer>(Integer.parseInt(entry.getKey()), Integer.parseInt(entry.getValue())));
        }
        ...
        public void run() {
            ...
            while (!quit) {
                ...
                while (index < conn.zcard("known:")) {
                    ...
                    String cutoff =
                        String.valueOf(((System.currentTimeMillis() + timeOffset) / 1000) - sampleCount * prec);
